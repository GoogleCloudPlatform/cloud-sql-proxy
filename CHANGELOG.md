...
* update dependencies to latest versions ([#2664](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2664)) ([56d07d2](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/56d07d2655bf43ae9addd3ef25dd87523a8e1bec))

## [1.38.2](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.38.1...v1.38.2) (2026-07-24)
...
* update dependencies to latest ([#2620](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2620)) ([d3d5474](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/d3d547405ac3cc74ea47b7c23c8947858317d584))
...
* update dependencies to latest versions ([#2570](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2570)) ([80470d1](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/80470d1f1d782872f580c8d70f3d6b8e8a9aa438))

## [1.37.13](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.37.12...v1.37.13) (2026-02-19)


### Bug Fixes

* Update dependencies to latest. ([#2558](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2558)) ([6a15e8c](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/6a15e8c7b7dd2d796a04a209886889d695b72ee2))

## [1.37.12](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.37.11...v1.37.12) (2026-01-20)


### Bug Fixes

* update deps to latest on v1 ([#2537](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2537)) ([e625b37](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/e625b37a63014bbaa111e7742e5552a4fdae45c2))

## [1.37.11](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.37.10...v1.37.11) (2025-12-09)


### Bug Fixes

* Update dependency versions. ([#2523](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2523)) ([33d85cd](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/33d85cdf19b5f251068d26e9e452f79abd1c0be5))

## [1.37.10](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.37.9...v1.37.10) (2025-10-23)


### Bug Fixes

* update dependencies to latest versions ([#2501](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2501)) ([76ef163](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/76ef163bd5da954475e8f0b9004f1280e1c741d8))

## [1.37.9](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.37.8...v1.37.9) (2025-08-25)


### Bug Fixes

* update dependencies to latest versions ([#2485](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2485)) ([068d0f9](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/068d0f918d91f8cc04aa50d45caad5335c990bac))

## [1.37.8](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.37.7...v1.37.8) (2025-07-15)


### Bug Fixes

* bump dependencies to latest ([#2469](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2469)) ([ae90913](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/ae909135eef1bdfb153eb4e1d5224f058857f66d))

## [1.37.7](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.37.6...v1.37.7) (2025-04-16)


### Bug Fixes

* update dependencies to latest versions ([#2431](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2431)) ([0c8ab19](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/0c8ab193d02250855242ec4b9ce4adcb09fe4f31))

## [1.37.6](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.37.5...v1.37.6) (2025-03-20)


### Bug Fixes

* bump v1 dependencies to latest ([#2406](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2406)) ([1b19ec3](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/1b19ec38dc4511f8e2c52a6f33399572d6acf57e))

## [1.37.5](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.37.4...v1.37.5) (2025-02-19)


### Bug Fixes

* update dependencies to latest versions ([#2391](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2391)) ([e7889d3](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/e7889d3240f12fea178099adfb2e20b6e2f90f9a))
...
* bump v1 deps to latest ([#2344](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2344)) ([c3ee873](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/c3ee873ca409bc80244ca63e43447531e7826cec))

## [1.37.2](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.37.1...v1.37.2) (2024-11-21)


### Bug Fixes

* bump v1 dependencies to latest ([#2330](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2330)) ([508f5de](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/508f5de8fe989ebed004a2d208007bb9f2205bf3))
...
* bump v1 to Go 1.23 ([#2289](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2289)) ([abd004b](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/abd004bd0787989cbc908cb160d9562494905e7f))
...
* update dependencies to latest versions ([#2246](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2246)) ([70de528](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/70de528d57d5b45c3bf94720ccfb202554fb5561))

## [1.35.3](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.35.2...v1.35.3) (2024-05-16)


### Bug Fixes

* bump v1 dependencies to latest ([#2220](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2220)) ([a8432e1](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/a8432e171a00c788831faf9eddf8f6fdcc05a445))
...
* release 1.35.1 ([#2189](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2189)) ([b89d5c3](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/b89d5c303f8aa7848a5effd3eedbfc170557ebc9))
...
* bump dependencies to latest ([#2150](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2150)) ([ea08877](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/ea0887746dc122b724c8d14b518e9f23e2d1f55e))

## [1.34.0](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.33.16...v1.34.0) (2024-02-20)


### Features

* bump to Go 1.22 ([#2121](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2121)) ([a72afb5](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/a72afb57378fc28a237bfd442055f7ce52f7a317))

## [1.33.16](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.33.15...v1.33.16) (2024-01-17)


### Bug Fixes

* update v1 dependencies to latest versions ([#2090](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2090)) ([da86084](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/da860848cca4c1c7fbe5853c48ac8c9f681404b0))

## [1.33.15](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.33.14...v1.33.15) (2023-12-04)


### Bug Fixes

* update dependencies to latest versions ([#2053](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2053)) ([879ea6a](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/879ea6a3cb3d405ad5dd1043360e48785dde8432))

## [1.33.14](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/compare/v1.33.13...v1.33.14) (2023-11-14)


### Bug Fixes

* update deps to latest ([#2028](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/2028)) ([684fad0](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/684fad02f88c1d2c1f781109c86a8ffde5d10c3d))
...
* bump dependencies to latest ([#1961](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/issues/1961)) ([82c13cb](https://github.com/GoogleCloudPlatform/cloud-sql-proxy/commit/82c13cb59a9af54de870b20080546efca2c20487))

...
URL="https://storage.googleapis.com/cloud-sql-connectors/cloud-sql-proxy/v2.23.1"
...
```sh
# see Releases for other versions
curl https://storage.googleapis.com/cloud-sql-connectors/cloud-sql-proxy/v2.23.1/cloud-sql-proxy.x64.exe -o cloud-sql-proxy.exe
```
...
```sh
# see Releases for other versions
curl https://storage.googleapis.com/cloud-sql-connectors/cloud-sql-proxy/v2.23.1/cloud-sql-proxy.x86.exe -o cloud-sql-proxy.exe
```
...
``` shell
# $VERSION is 2.23.1
docker pull gcr.io/cloud-sql-connectors/cloud-sql-proxy:2.23.1
```

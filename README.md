...
URL="https://storage.googleapis.com/cloud-sql-connectors/cloud-sql-proxy/v2.14.0"
...
```sh
# see Releases for other versions
curl https://storage.googleapis.com/cloud-sql-connectors/cloud-sql-proxy/v2.14.0/cloud-sql-proxy.x64.exe -o cloud-sql-proxy.exe
```
...
```sh
# see Releases for other versions
curl https://storage.googleapis.com/cloud-sql-connectors/cloud-sql-proxy/v2.14.0/cloud-sql-proxy.x86.exe -o cloud-sql-proxy.exe
```
